...
@implementation LckukynumberWWebViJBri {
    __weak WKWebView* _webView;
    __weak id<WKNavigationDelegate> _webViewDelegate;
    long _uniqueId;
    LckukynumberWebViewJBriBase *_base;
}

/* API
 *****/

+ (void)enableLogging { [LckukynumberWebViewJBriBase enableLogging]; }

+ (instancetype)bridForWebView:(WKWebView*)webView {
    LckukynumberWWebViJBri* bridge = [[self alloc] init];
...
- (void) _setupInstance:(WKWebView*)webView {
    ...
    _base = [[LckukynumberWebViewJBriBase alloc] init];
    _base.delegate = self;
}
