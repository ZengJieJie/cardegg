//
//  DoubleAdditionViewController.swift
//  Lckukynumber
//
...
class DoubleAdditionViewController: LckukynumberBaseViewController {
    ...
    var LckyNumbercheng: Int = 0
    var LckyNumberchu: Int = 0
    ...
    override func viewDidLoad() {
        ...
        self.LckyNumber = RandomgenerationLckyNumber(between: 7, and: 39)
        self.LckyNumberjian = RandomgenerationLckyNumber(between: 2, and: 19)
        self.LckyNumbercheng = numbers.randomElement()!
        self.LckyNumberchu = RandomgenerationLckyNumber(between: 2, and: 5)
        
        self.bRandomaray = bRandomarayRandomNumbers(count: 36, min: 1, max: 20)
        self.luckynumber.text="Lucky:\(self.LckyNumber) \(self.LckyNumberjian) \(self.LckyNumbercheng) \(self.LckyNumberchu)"
    ...
    @IBAction func restartbtn(_ sender: Any) {
        ...
        let okAction = UIAlertAction(title: "OK", style: .default) { [self] _ in
            ...
            self.LckyNumber = RandomgenerationLckyNumber(between: 7, and: 18)
            self.LckyNumberjian = RandomgenerationLckyNumber(between: 2, and: 9)
            self.LckyNumbercheng = numbers.randomElement()!
            self.LckyNumberchu = RandomgenerationLckyNumber(between: 2, and: 5)
    ...
    @objc func buttonClicked(_ sender: UIButton) {
        ...
        if let lastButton = lastNIBButton, let secondButton = secondNIBButton {
            if let ac = bRandomaray[lastButton.tag] as? NSNumber, let bc = bRandomaray[secondButton.tag] as? NSNumber {
                let acbccheng = ac.intValue * bc.intValue
                let acbcchu = bc.intValue / ac.intValue
                let acbcjia = ac.intValue + bc.intValue
                let acbcjian = bc.intValue - ac.intValue

                if (acbccheng == LckyNumber || acbcchu == LckyNumber||acbcjia == LckyNumber || acbcjian == LckyNumber||acbccheng == LckyNumberjian || acbcchu == LckyNumberjian||acbcjia == LckyNumberjian || acbcjian == LckyNumberjian||acbccheng == LckyNumbercheng || acbcchu == LckyNumbercheng||acbcjia == LckyNumbercheng || acbcjian == LckyNumbercheng||acbccheng == LckyNumberchu || acbcchu == LckyNumberchu||acbcjia == LckyNumberchu || acbcjian == LckyNumberchu) {
